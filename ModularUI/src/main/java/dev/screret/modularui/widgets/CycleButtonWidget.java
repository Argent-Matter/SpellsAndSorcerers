...
import dev.screret.modularui.api.value.IIntValue;
 ...
 * automatically set, if the passed {@link dev.screret.modularui.api.value.IIntValue} is a
 * {@link dev.screret.modularui.api.value.IEnumValue IEnumValue} or a
 * {@link dev.screret.modularui.api.value.IBoolValue IBoolValue}.
 * </p>
 * 
 * @see ToggleButton
 */
