...
import dev.screret.modularui.drawable.HoverableIcon;
import dev.screret.modularui.drawable.InteractableIcon;
...
public interface IIcon extends IDrawable {
     ...
     * {@link dev.screret.modularui.drawable.text.RichText RichText}.
