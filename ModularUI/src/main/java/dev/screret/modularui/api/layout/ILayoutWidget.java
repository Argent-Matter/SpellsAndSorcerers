package dev.screret.modularui.api.layout;

import dev.screret.modularui.api.GuiAxis;
import dev.screret.modularui.api.widget.INotifyEnabled;
 ...
 * size with
 * {@link dev.screret.modularui.widget.sizer.Area#setSize(GuiAxis, int)} or one of its variants on each child.
 * The same goes for
