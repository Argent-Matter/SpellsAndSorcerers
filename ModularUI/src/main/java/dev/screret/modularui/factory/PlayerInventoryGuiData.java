...
import dev.screret.modularui.factory.inventory.InventoryType;
...
public class PlayerInventoryGuiData<T> extends GuiData {
    ...
    public static <T> PlayerInventoryGuiData<T> of(@NotNull Player player, @NotNull InventoryType<T> inventoryType, T context,
                                                   int slotIndex) {
