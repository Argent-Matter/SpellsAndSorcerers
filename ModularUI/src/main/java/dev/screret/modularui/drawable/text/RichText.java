...
import dev.screret.modularui.api.drawable.*;
import dev.screret.modularui.client.component.DrawableTooltipComponent;
import dev.screret.modularui.client.component.TooltipComponentIcon;
...
import dev.screret.modularui.utils.TooltipLines;
...
public class RichText implements IDrawable, IRichTextBuilder<RichText> {
     ...
     * Note that this method assumes, that the {@link dev.screret.modularui.api.layout.IViewportStack
     * IViewportStack}
