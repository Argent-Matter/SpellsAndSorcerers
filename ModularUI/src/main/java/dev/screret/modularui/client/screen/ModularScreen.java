...
import dev.screret.modularui.overlay.OverlayScreenWrapper;
...
import dev.screret.modularui.widget.wrapper.WidgetWrapper;
...
public class ModularScreen implements GuiEventListener, Renderable, LayoutElement, NarratableEntry {
     ...
     * {@link dev.screret.modularui.api.widget.Interactable#onMousePressed(double, double, int)
     ...
     * {@link dev.screret.modularui.api.widget.Interactable#onMouseReleased(double, double, int)
     ...
     * {@link dev.screret.modularui.api.widget.Interactable#onKeyPressed(int, int, int)
     ...
     * {@link dev.screret.modularui.api.widget.Interactable#onKeyReleased(int, int, int)
    ...
    /**
     * Called when a keyboard key is released. Tries to invoke
     * {@link dev.screret.modularui.api.widget.Interactable#onCharTyped(char, int)
    ...
    /**
     * Called when a mouse button is released. Tries to invoke
     * {@link dev.screret.modularui.api.widget.Interactable#onMouseScrolled(double, double, double, double)
     ...
     * {@link dev.screret.modularui.api.widget.Interactable#onMouseDrag(double, double, int, double, double)
     ...
     * {@link dev.screret.modularui.api.widget.IFocusedWidget IFocusedWidget}
     ...
     * Use {@link dev.screret.modularui.widget.Widget#listenGuiAction(IGuiAction)
