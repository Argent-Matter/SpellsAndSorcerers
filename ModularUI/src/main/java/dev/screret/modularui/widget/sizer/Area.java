package dev.screret.modularui.widget.sizer;
...
import dev.screret.modularui.utils.Point;
...
public class Area extends Rectangle implements IUnResizeable, IAnimatable<Area> {
     ...
     * Use {@link dev.screret.modularui.api.widget.IWidget#isInside(IViewportStack, int, int)} rather than
     * this!
     */
     ...
     * Use {@link dev.screret.modularui.api.widget.IWidget#isInside(IViewportStack, Point)} rather than
     * this!
     */
