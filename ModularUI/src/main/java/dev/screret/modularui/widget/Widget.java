...
public class Widget<W extends Widget<W>> implements IWidget, IPositioned<W>, ITooltip<W>, ISynced<W> {
     ...
     * Custom visuals should be drawn here. For example the {@link dev.screret.modularui.widgets.slot.ItemSlot
     ...
     * {@link dev.screret.modularui.value.sync.PanelSyncManager PanelSyncManager} for this to work.
