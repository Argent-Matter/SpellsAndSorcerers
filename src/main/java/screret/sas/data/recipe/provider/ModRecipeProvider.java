...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pFinishedRecipeConsumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.SOULSTEEL_BOOTS.get()).define('X', ModTags.Items.SOULSTEEL_INGOTS).pattern("X X").pattern("X X").unlockedBy("has_diamond", has(ModTags.Items.SOULSTEEL_INGOTS)).save(pFinishedRecipeConsumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.SOULSTEEL_CHESTPLATE.get()).define('X', ModTags.Items.SOULSTEEL_INGOTS).pattern("X X").pattern("XXX").pattern("XXX").unlockedBy("has_diamond", has(ModTags.Items.SOULSTEEL_INGOTS)).save(pFinishedRecipeConsumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.SOULSTEEL_HELMET.get()).define('X', ModTags.Items.SOULSTEEL_INGOTS).pattern("XXX").pattern("X X").unlockedBy("has_diamond", has(ModTags.Items.SOULSTEEL_INGOTS)).save(pFinishedRecipeConsumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.SOULSTEEL_HOE.get()).define('#', ModItems.HANDLE.get()).define('X', ModTags.Items.SOULSTEEL_INGOTS).pattern("XX").pattern(" #").pattern(" #").unlockedBy("has_diamond", has(ModTags.Items.SOULSTEEL_INGOTS)).save(pFinishedRecipeConsumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.SOULSTEEL_LEGGINGS.get()).define('X', ModTags.Items.SOULSTEEL_INGOTS).pattern("XXX").pattern("X X").pattern("X X").unlockedBy("has_diamond", has(ModTags.Items.SOULSTEEL_INGOTS)).save(pFinishedRecipeConsumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.SOULSTEEL_PICKAXE.get()).define('#', ModItems.HANDLE.get()).define('X', ModTags.Items.SOULSTEEL_INGOTS).pattern("XXX").pattern(" # ").pattern(" # ").unlockedBy("has_diamond", has(ModTags.Items.SOULSTEEL_INGOTS)).save(pFinishedRecipeConsumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.SOULSTEEL_SHOVEL.get()).define('#', ModItems.HANDLE.get()).define('X', ModTags.Items.SOULSTEEL_INGOTS).pattern("X").pattern("#").pattern("#").unlockedBy("has_diamond", has(ModTags.Items.SOULSTEEL_INGOTS)).save(pFinishedRecipeConsumer);
