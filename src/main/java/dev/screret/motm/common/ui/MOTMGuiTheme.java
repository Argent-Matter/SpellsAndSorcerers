...
public class MOTMGuiTheme {
    ...
    private static final List<MOTMGuiTheme> THEMES = new ArrayList<>();
    ...
    private MOTMGuiTheme(String themeId) {
    ...
    public static void onReloadThemes(ReloadThemeEvent.Pre event) {
        THEMES.forEach(MOTMGuiTheme::buildJson);
    }
    ...
    public static class Builder {
        ...
        private final MOTMGuiTheme theme;

        public Builder(String themeId) {
            theme = new MOTMGuiTheme(themeId);
        }
