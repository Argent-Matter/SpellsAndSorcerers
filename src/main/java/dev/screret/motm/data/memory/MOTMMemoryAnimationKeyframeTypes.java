...
public class MOTMMemoryAnimationKeyframeTypes {
    ...
    public static final DeferredHolder<DataComponentType<? extends MemoryKeyframe>, DataComponentType<EntityTrackerKeyframe>> ENTITY_TRACKER = MEMORY_ANIMATION_KEYFRAME_TYPES.register("entity_tracker",
            () -> DataComponentType.<EntityTrackerKeyframe>builder()
                    .persistent(EntityTrackerKeyframe.CODEC).networkSynchronized(EntityTrackerKeyframe.STREAM_CODEC)
                    .build());
