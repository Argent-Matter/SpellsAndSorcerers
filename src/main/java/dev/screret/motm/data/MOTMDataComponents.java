...
public class MOTMDataComponents {
    ...
    public static final DeferredRegister<DataComponentType<?>> DATA_COMPONENTS = DeferredRegister
            .create(BuiltInRegistries.DATA_COMPONENT_TYPE, MagicOfTheMind.MODID);

    public static final DeferredHolder<DataComponentType<?>, DataComponentType<WandComponent>> WAND = DATA_COMPONENTS.register(
            "wand",
            () -> DataComponentType.<WandComponent>builder()
                    .persistent(WandComponent.CODEC).networkSynchronized(WandComponent.STREAM_CODEC)
                    .build());
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<WandAbilityInstance>> WAND_CORE = DATA_COMPONENTS
            .register("wand_core",
