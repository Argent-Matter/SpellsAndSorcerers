package dev.screret.sas.ability;

import net.minecraft.core.particles.ParticleTypes;
import net.minecraft.world.phys.Vec3;
import dev.screret.sas.ability.ability.*;
import dev.screret.sas.api.wand.ability.WandAbility;

import java.util.function.Supplier;

import static dev.screret.sas.api.wand.ability.WandAbilityRegistry.WAND_ABILITIES;
