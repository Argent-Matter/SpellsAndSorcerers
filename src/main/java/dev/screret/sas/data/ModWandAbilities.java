...
public class ModWandAbilities {
    public static final DeferredRegister<WandAbility> WAND_ABILITIES = DeferredRegister.create(SASRegistries.WAND_ABILITIES, SpellsAndSorcerers.MODID);
    
    public static final DeferredHolder<WandAbility, WandAbility> DUMMY = WAND_ABILITIES.register("dummy", () -> new WandAbility(0, 0, 0, false, null, 0xFF000000));

    public static final DeferredHolder<WandAbility, ShootAbility> SHOOT_RAY = WAND_ABILITIES.register("shoot_ray", () -> new ShootAbility(0, 0, 0, true, ParticleTypes.SOUL_FIRE_FLAME, 0xFF54cbcf, 32, Vec3.ZERO));
    public static final DeferredHolder<WandAbility, ShootAbility> SHOOT_HOLD_DOWN = WAND_ABILITIES.register("shoot_hold_down", () -> new ShootAbility(20, 20, 0, true, ParticleTypes.HAPPY_VILLAGER, 0xFF00ae2d, 16, Vec3.ZERO));
    public static final DeferredHolder<WandAbility, ShootAbility> SHOOT_ANGRY_RAY = WAND_ABILITIES.register("shoot_angry_ray", () -> new ShootAbility(100, 200, 0, true, ExplodeAbility.PARTICLE, 0xFFAA0000, 8, ExplodeAbility.RANDOM_DEVIATION));
    public static final DeferredHolder<WandAbility, ShootAbility> SHOOT_LIGHTNING = WAND_ABILITIES.register("shoot_lightning", () -> new ShootAbility(0, 25, 0, true, ParticleTypes.ELECTRIC_SPARK, 0xFFAAAAAA, 32, Vec3.ZERO));
