package dev.screret.sas.api.wand.ability;
...
public class WandAbility {
    ...
    public static final Codec<WandAbility> DIRECT_CODEC = SASRegistries.WAND_ABILITIES.byNameCodec().dispatchStable(Function.identity(), WandAbility::codec);
    ...
    public ResourceLocation getKey() {
        return SASRegistries.WAND_ABILITIES.getKey(this);
    }
