...
public class MITMUtil {
    ...
    public static ItemStack createWand(WandAbility main, @Nullable WandAbility crouch) {
        ...
        ItemStack stack = new ItemStack(MITMItems.WAND.get(), 1);
    ...
    public static ItemStack addWandCore(WandAbility ability) {
        var coreStack = new ItemStack(MITMItems.WAND_CORE.get(), 1);
        var tag = new CompoundTag();
    ...
    public static WandAbility getAbilityFromJson(JsonObject json, String key) {
        return MITMRegistries.WAND_ABILITIES.get(ResourceLocation.parse(GsonHelper.getAsString(json, key)));
    }
