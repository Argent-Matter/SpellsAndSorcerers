...
public class MITMItemTagsProvider extends ItemTagsProvider {
    ...
    public MITMItemTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider,
    ...
    protected void addTags(HolderLookup.Provider registries) {
        ...
        tag(MITMTags.Items.BOSS_SUMMON_ITEMS).add(MITMItems.WAND_CORE.get(), Items.GLOWSTONE_DUST, Items.LAPIS_BLOCK,
                Items.ZOMBIE_HEAD);
