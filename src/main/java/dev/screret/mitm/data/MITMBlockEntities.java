...
public class MITMBlockEntities {
    ...
    public static final Supplier<BlockEntityType<SummonSignBlockEntity>> SUMMON_SIGN = BLOCK_ENTITIES.register("summon_sign",
            () -> BlockEntityType.Builder.of(SummonSignBlockEntity::new, MITMBlocks.SUMMON_SIGN.get()).build(null));
