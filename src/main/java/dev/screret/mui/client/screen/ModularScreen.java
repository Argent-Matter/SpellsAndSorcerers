...
public class ModularScreen implements GuiEventListener, Renderable, LayoutElement, NarratableEntry {
     ...
     * {@link dev.screret.mui.api.widget.Interactable#onMousePressed(double, double, int)
     ...
     * {@link dev.screret.mui.api.widget.Interactable#onMouseReleased(double, double, int)
     ...
     * {@link dev.screret.mui.api.widget.Interactable#onKeyPressed(int, int, int)
     ...
     * {@link dev.screret.mui.api.widget.Interactable#onKeyReleased(int, int, int)
    ...
    /**
     * Called when a keyboard key is released. Tries to invoke
     * {@link dev.screret.mui.api.widget.Interactable#onCharTyped(char, int)
     ...
     * {@link dev.screret.mui.api.widget.Interactable#onMouseDrag(double, double, int, double, double)
     ...
     * {@link dev.screret.mui.api.widget.IFocusedWidget IFocusedWidget}
     ...
     * Use {@link dev.screret.mui.widget.Widget#listenGuiAction(IGuiAction)
