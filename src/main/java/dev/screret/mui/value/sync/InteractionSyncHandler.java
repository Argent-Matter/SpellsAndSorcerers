...
import dev.screret.mui.api.value.sync.IServerKeyboardAction;
import dev.screret.mui.api.value.sync.IServerMouseAction;
import dev.screret.mui.utils.KeyboardData;
