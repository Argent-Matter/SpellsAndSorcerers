...
import dev.screret.mui.animation.IAnimatable;
...
public class Area extends Rectangle implements IUnResizeable, IAnimatable<Area> {
     ...
     * Use {@link dev.screret.mui.api.widget.IWidget#isInside(IViewportStack, int, int)} rather than
     * this!
     */
     ...
     * Use {@link dev.screret.mui.api.widget.IWidget#isInside(IViewportStack, Point)} rather than
     * this!
     */
