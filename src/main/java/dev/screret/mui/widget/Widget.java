...
public class Widget<W extends Widget<W>> implements IWidget, IPositioned<W>, ITooltip<W>, ISynced<W> {
     ...
     * {@link IUIHolder#buildUI(GuiData, dev.screret.mui.value.sync.PanelSyncManager, dev.screret.mui.client.screen.UISettings)}
     ...
     * Custom visuals should be drawn here. For example the {@link dev.screret.mui.widgets.slot.ItemSlot
     ...
     * {@link dev.screret.mui.value.sync.PanelSyncManager PanelSyncManager} for this to work.
