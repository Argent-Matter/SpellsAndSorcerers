 ...
 * automatically set, if the passed {@link dev.screret.mui.api.value.IIntValue} is a
 * {@link dev.screret.mui.api.value.IEnumValue IEnumValue} or a
 * {@link dev.screret.mui.api.value.IBoolValue IBoolValue}.
 * </p>
 * 
 * @see ToggleButton
 */
